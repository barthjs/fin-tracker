        ...
        return $table
            ...
            ->groups([
                Group::make('category.group')
                    ->label('')
                    ->collapsible()
                    ->getTitleFromRecordUsing(fn(CategoryStatistic $record): string => __('transaction_category.groups')[$record->category->group->name])
            ])
            ->striped()
            ->filters([
                SelectFilter::make('year')
                    ->options(fn(): array => CategoryStatistic::select('year')
                        ->distinct()
                        ->orderBy('year', 'desc')
